...
Any Functor that has an `.of` method is a pointed Functor. Why is this important? This concept is used in `Monads`.
Monads help when you have nested functors like `Maybe(Maybe(value))`
