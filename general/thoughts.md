...
> Inspired by [this great post](https://pdelboca.me/writings/2025/08/01/vibe-coding-fast-fashion.html)

If you are a product engineer or a leader, you always _build_ stuff. New features, new thing, new that.

But have you considered, albeit a bit radical, alternative of _not building_ stuff?

Yes, you have to build _some features_, but I believe we have a problem in software – we lack the discipline skip _not building_ certain things.

Consider that _every_ piece of code you write, especially the one generated by AI, needs to be secured and maintained. Yes, the game is a bit different when you are building a proof-of-concept (how many of those became "production" applications?), but in general, **not building could be as useful as building**.

If you skip building _that_ one thing:

1. You have time to thing about the thing you _really_ need to build.
2. You have time to rest.
